...
extern INT angle_cos_size;
MAKE_STR_DEC_INNER(INT,angle_cos_size)

/*! Array of interacting beads. */
extern PTR_INT angle_cos_pairs;
MAKE_STR_DEC_INNER(PTR_INT,angle_cos_pairs)

/*! Array of interacting beads parameters. */
extern PTR_DOUBLE angle_cos_phis;
MAKE_STR_DEC_INNER(PTR_DOUBLE,angle_cos_phis)
...
INT angle_cos_calc( DOUBLE* F, int pos, DOUBLE* E  );
